...
## From C#
1. Install proj.db to your system. Read [**these instructions**](https://proj.org/resource_files.html#where-are-proj-resource-files-looked-for) or [use these my version](https://github.com/GeorgGrebenyuk/PROJ_NET_lib_cad#firstly).
2. Unzip my cpp proj's lib (watch "proj_functions_ver-\*\*\*.zip" in Releases),  [look that last Release](https://github.com/GeorgGrebenyuk/PROJ_NET_lib_cad/releases/tag/v1.2.0)
